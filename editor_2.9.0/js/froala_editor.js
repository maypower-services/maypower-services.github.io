...
(function (factory) {
  ...
  $.FE.MODULES.selection = function (editor) {
          ...
          try {
            ...
            if (!special_case) {
              ...
              if ((editor.browser.chrome || editor.browser.edge) && start_marker.nextSibling == end_marker) {
                ...
                // https://github.com/froala/wysiwyg-editor/issues/1120 . TODO Check again the below statement on which !editor.opts.enter == $.FE.ENTER_BR is returing false always. id:28
    ...
    /**
     * TODO: check again this function because it will always return true because fr-inner tag does not exist. id:22
     */
