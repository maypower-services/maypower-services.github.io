...
(function (factory) {
  ...
  $.FE.PLUGINS.codeBeautifier = function () {
    ...
    function css_beautify (source_text, options) {
        ...
        // HACK: newline parsing inconsistent. This brute force normalizes the input. id:19
    ...
    function Beautifier(js_source_text, options) {
        ...
        function handle_start_expr() {
            ...
            if (flags.last_text === ';' || last_type === 'TK_START_BLOCK') {
                ...
                // TODO: Consider whether forcing this is required. Review failing tests when removed. id:13
        ...
        function handle_word() {
            ...
            if (last_type === 'TK_END_BLOCK') {
                ...
                // TODO: Should this be for STATEMENT as well? id:30
                prefix = 'NEWLINE';
